...
public static class Hooks
{
    public sealed class StateHandle<T>
    {
        ...
        public StateHandle(HookSlot slot) { this.slot = slot; }
        public T Value
        {
            get => (T)slot.Value!;
            set => slot.Value = value;
        }
        public void Set(T v) => slot.Value = v;
    }
    ...
    {
        private readonly HookSlot slot;
        public RefHandle(HookSlot slot) { this.slot = slot; }
        public T Current
        {
            get => (T)slot.Value!;
            set => slot.Value = value;
    ...
    public static Theme.Theme UseTheme() => RenderContext.Current.Theme;
    public static ISystemSkin? UseSystemSkin() => RenderContext.Current.Skin;
    public static Direction UseDirection() => RenderContext.Current.Direction;
