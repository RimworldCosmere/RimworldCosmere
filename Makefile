...
info: ## Show project information
	...
	@echo "                         Contains all systems: framework, core mechanics, Scadrial, Roshar, Nalthis"
	...
	@echo "  CosmereNalthis       - XML defs and assets for Awakening and BioChromatic Breath"
	@echo ""
	@echo "$(GREEN)Tools:$(NC)"
