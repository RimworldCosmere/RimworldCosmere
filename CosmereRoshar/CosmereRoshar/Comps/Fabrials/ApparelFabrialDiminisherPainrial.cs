    ...
    public class CompApparelFabrialDiminisher : ThingComp {
        ...
        public override void Notify_Equipped(Pawn pawn) {
            ...
            if (!pawn.health.hediffSet.HasHediff(CosmereRosharDefs.whtwl_apparel_painrial_diminisher_hediff)) {
                var hediff = HediffMaker.MakeHediff(CosmereRosharDefs.whtwl_apparel_painrial_diminisher_hediff, pawn);
    ...
    public class HediffComp_FabrialPainDiminisher : HediffComp {
        ...
        public override void CompPostTick(ref float severityAdjustment) {
            ...
            foreach (var apparel in pawn.apparel.WornApparel) {
                ...
                if (!comp.checkPower()) {
                    var hediff = pawn.health.hediffSet.GetFirstHediffOfDef(CosmereRosharDefs.whtwl_apparel_painrial_diminisher_hediff);
                    if (hediff != null) {
