...
public static class AdapterStoreRegistry
{
    private readonly struct Key : IEquatable<Key>
    {
        ...
        public bool Equals(Key other) => EntityId == other.EntityId && Kind == other.Kind && SubKey == other.SubKey;
    ...
    public static Guid Get(int entityId, AdapterKind kind) => Get(entityId, kind, 0);
