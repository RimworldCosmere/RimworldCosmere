...
namespace CosmereRoshar {
    ...
    public class PawnStats : ThingComp {
        ...
        public override void Initialize(CompProperties props) {
            ...
            //WINDRUNNER
            var windrunnerDefName = CosmereRosharDefs.whtwl_Radiant_Windrunner.defName;
            ...
            //TRUTHWATCHER
            var truthwatcherDefName = CosmereRosharDefs.whtwl_Radiant_Truthwatcher.defName;
            ...
            //EDGEDANCER
            var edgedancerDefName = CosmereRosharDefs.whtwl_Radiant_Edgedancer.defName;
            ...
            //SKYBREAKER
            var skybreakerDefName = CosmereRosharDefs.whtwl_Radiant_Skybreaker.defName;
...
namespace CosmereRoshar {
    ...
    public static class Whtwl_RadiantNeedLevelupChecker {
        public static void UpdateIsSatisfiedReq1_2(PawnStats pawnStats) {
            var windrunnerRequirement = pawnStats.requirementMap[CosmereRosharDefs.whtwl_Radiant_Windrunner.defName][pawnStats.Props.Req_1_2];
            if (windrunnerRequirement.Count >= 1 && pawnStats.PatientSaved) {
                windrunnerRequirement.IsSatisfied = true;
            }

            var truthwatcherRequirement = pawnStats.requirementMap[CosmereRosharDefs.whtwl_Radiant_Truthwatcher.defName][pawnStats.Props.Req_1_2];
        ...
        public static void UpdateIsSatisfiedReq2_3(PawnStats pawnStats) {//helped enemy in need
            var windrunnerRequirement = pawnStats.requirementMap[CosmereRosharDefs.whtwl_Radiant_Windrunner.defName][pawnStats.Props.Req_2_3];
        ...
        public static void UpdateIsSatisfiedReq3_4(PawnStats pawnStats) { //ally with bond died even tho tried to save
            var windrunnerRequirement = pawnStats.requirementMap[CosmereRosharDefs.whtwl_Radiant_Windrunner.defName][pawnStats.Props.Req_3_4];
            windrunnerRequirement.IsSatisfied = true;
        }
    ...
    public static class Whtwl_MentalBreakExperiences {
        ...
        static void Postfix(MentalBreaker __instance, int delta, Pawn ___pawn) {
            if (___pawn.IsHashIntervalTick(100)) {
                ...
                if (pawnStats != null && pawnStats.hasFormedBond == false) {
                    ...
                    if (increment > 0f) {
                        pawnStats.requirementMap[CosmereRosharDefs.whtwl_Radiant_Windrunner.defName][pawnStats.Props.Req_0_1].Value += increment;
                    }
    ...
    public static class Whtwl_HelpSomeoneInNeed {
        static void Postfix(Pawn doctor, Pawn patient, Medicine medicine) {
            ...
            if (pawnStats != null) {
                ...
                // WINDRUNNER
                var windrunnerRequirement1_2 = pawnStats.requirementMap[CosmereRosharDefs.whtwl_Radiant_Windrunner.defName][pawnStats.Props.Req_1_2];
                ...
                if (patient.IsPrisoner) {
                    var windrunnerRequirement2_3 = pawnStats.requirementMap[CosmereRosharDefs.whtwl_Radiant_Windrunner.defName][pawnStats.Props.Req_2_3];
            ...
            if (___pawn.IsHashIntervalTick(100)) {
                ...
                foreach (Pawn patient in pawnStats.PatientList) {
                    ...
                    if (patient.health.Dead && patient.IsPrisoner == false) {
                        ...
                        pawnStats.requirementMap[CosmereRosharDefs.whtwl_Radiant_Windrunner.defName][pawnStats.Props.Req_3_4].IsSatisfied = true;
                        patientsToRemove.Add(patient);
                    }
