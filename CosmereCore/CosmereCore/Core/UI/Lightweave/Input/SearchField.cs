...
{
    private const string MagnifyingGlyph = "⌕";
    ...
    {
        LightweaveNode node = NodeBuilder.New("SearchField", line, caller ?? string.Empty);
        ...
        node.Paint = (rect, paintChildren) =>
        {
            ...
            Hooks.Hooks.RefHandle<string> syncedFrom = Hooks.Hooks.UseRef<string>(value ?? string.Empty);
            ...
            DrawGlyph(glyphRect, MagnifyingGlyph, theme, ThemeSlot.TextMuted);
