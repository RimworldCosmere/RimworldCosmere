...
public class ITab_StorageWithInventory : ITab_Storage {
    ...
    public ITab_StorageWithInventory() {
        size = WinSize;
        labelKey = "TabStorage";
    }

    public ITab_StorageWithInventory(string labelKey, InnerStorage? storage = null) {
        size = WinSize;
