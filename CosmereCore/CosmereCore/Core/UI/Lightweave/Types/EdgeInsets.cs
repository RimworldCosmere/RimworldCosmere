    ...
    Rem? End = null)
{
    ...
    public static EdgeInsets All(Rem v) => new EdgeInsets(v, v, v, v);
    public static EdgeInsets Horizontal(Rem v) => new EdgeInsets(Left: v, Right: v);
    public static EdgeInsets Vertical(Rem v) => new EdgeInsets(Top: v, Bottom: v);
