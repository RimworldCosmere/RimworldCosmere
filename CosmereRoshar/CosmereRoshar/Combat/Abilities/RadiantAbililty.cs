...
namespace CosmereRoshar {
    ...
    public class Command_RadiantAbility : Command {
        ...
        public override void ProcessInput(Event ev) {
            ...
            if (pawn.Drafted && (hasRadiantTrait || pawn.GetAbilityComp<CompAbilityEffect_SpawnEquipment>(CosmereRosharDefs.whtwl_SummonShardblade.defName) != null)) {
        ...
        private bool abilityWindRunnerFlight() {
            if (ability.def == CosmereRosharDefs.whtwl_WindRunnerFlight) {
                float cost = pawn.GetAbilityComp<CompAbilityEffect_AbilityWindRunnerFlight>(CosmereRosharDefs.whtwl_WindRunnerFlight.defName).Props.stormLightCost;
