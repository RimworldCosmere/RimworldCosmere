...
namespace CosmereScadrial.Abilities.Allomancy {
    public class IronPull : AbilityOtherTarget {
        public IronPull() { }

        public IronPull(Pawn pawn) : base(pawn) { }

        public IronPull(Pawn pawn, Precept sourcePrecept) : base(pawn, sourcePrecept) { }

        public IronPull(Pawn pawn, AbilityDef def) : base(pawn, def) { }

        public IronPull(Pawn pawn, Precept sourcePrecept, AbilityDef def) : base(pawn, sourcePrecept, def) { }
