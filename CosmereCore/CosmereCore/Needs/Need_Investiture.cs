...
{
    public class Need_Investiture : Need
    {
        public const int MaxInvestiture = 1000000;
        private const float DailyFall = 0.2f; // Investiture lost per day
        private const int TicksPerDay = 60000;
        private const float FallPerTick = DailyFall / TicksPerDay;

        public Need_Investiture(Pawn pawn) : base(pawn)
        {
