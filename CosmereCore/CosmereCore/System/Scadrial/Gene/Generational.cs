...
/// <summary>
///     Which generation of kandra this one is, and what that buys it.
/// </summary>
/// <remarks>
///     Kandra rank themselves by how far back they were made. First generation are the oldest
///     things walking on Scadrial and they know it; tenth generation take orders. The number is
///     rolled once and stored, because a kandra's generation is the one fact about it that
///     cannot change.
/// </remarks>
public class Generational : Verse.Gene {
