...
public class HediffEvolutionProperties : HediffCompProperties {
    public HediffEvolutionProperties() {
        compClass = typeof(HediffEvolution);
    }
}

public class HediffEvolution : HediffComp {
