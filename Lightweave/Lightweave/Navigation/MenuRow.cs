...
[Doc(
    ...
    WhenToUse = "Composing custom popovers / drawer panels / sidebars that need menu-row visuals without the full Menu widget.",
    SourcePath = "Lightweave/Lightweave/Navigation/MenuRow.cs"
)]
public static class MenuRow {
    ...
    [DocVariant("CL_Playground_Navigation_MenuRow_Default")]
    public static DocSample DocsDefault() {
        return new DocSample(() => MenuRow.Create("Open settings", onClick: () => { }));
    }

    [DocVariant("CL_Playground_Navigation_MenuRow_Danger", Order = 1)]
    public static DocSample DocsDanger() {
        return new DocSample(() => MenuRow.Create("Quit to desktop", onClick: () => { }, danger: true));
    }

    [DocVariant("CL_Playground_Navigation_MenuRow_Disabled", Order = 2)]
    public static DocSample DocsDisabled() {
        return new DocSample(() => MenuRow.Create("Coming soon", onClick: () => { }, disabled: true));
    }

    [DocUsage]
    public static DocSample DocsUsage() {
        return new DocSample(() => MenuRow.Create("Documentation", onClick: () => { }));
    }
}
